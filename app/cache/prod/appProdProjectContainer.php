...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mysql51-160.perso', 'port' => NULL, 'dbname' => 'brostreaqjstream', 'user' => 'brostreaqjstream', 'password' => 'Auxerre2', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a33f1d5da69594ca2274b5664d9ffb63cc588de2e660b1643ce921a911a469aa');
        return $instance;
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'mysql51-160.perso',
            'database_port' => NULL,
            'database_name' => 'brostreaqjstream',
            'database_user' => 'brostreaqjstream',
            'database_password' => 'Auxerre2',
