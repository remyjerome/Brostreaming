...
";
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["episodes"]) ? $context["episodes"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            ...
            echo "</a>
                    ...
                    <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("rj_stream_episode", array("s" => (isset($context["s"]) ? $context["s"] : null), "e" => $this->getAttribute($context["episode"], "episode", array()))), "html", null, true);
