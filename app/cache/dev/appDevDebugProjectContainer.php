...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admin.episode' => 'getAdmin_EpisodeService',
    ...
    /**
     * Gets the 'admin.episode' service.
     *
     * @return \rj\StreamBundle\Admin\EpisodeAdmin A rj\StreamBundle\Admin\EpisodeAdmin instance.
     */
    protected function getAdmin_EpisodeService()
    {
        $instance = new \rj\StreamBundle\Admin\EpisodeAdmin('admin.episode', 'rj\\StreamBundle\\Entity\\Episode', 'SonataAdminBundle:CRUD');
     ...
     *
     * @return \rj\StreamBundle\Admin\NewsAdmin A rj\StreamBundle\Admin\NewsAdmin instance.
     */
    protected function getAdmin_NewsService()
    {
        $instance = new \rj\StreamBundle\Admin\NewsAdmin('admin.news', 'rj\\StreamBundle\\Entity\\News', 'SonataAdminBundle:CRUD');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'brostreaqjstream', 'user' => 'admin', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/rj/StreamBundle/Entity'))), 'rj\\StreamBundle\\Entity');
        $b->addDriver($a, 'FOS\\UserBundle\\Entity');
        $b->addDriver($a, 'Sonata\\UserBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('rjStreamBundle' => 'rj\\StreamBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_be577c0663ecf85e6ed4fb485d3583c208d5802615b1c2d12967863e39a8cefb');
    ...
    {
        return $this->services['fos_user.group_manager'] = new \Sonata\UserBundle\Entity\GroupManager($this->get('fos_user.entity_manager'), 'Sonata\\UserBundle\\Entity\\BaseGroup');
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.context'), $this->get('security.user_checker.demo_secured_area'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \Sonata\UserBundle\Entity\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'Sonata\\UserBundle\\Entity\\BaseUser');
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener($this->get('request_stack'), 'fr_FR', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $h, 'demo_secured_area', $j, $k, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '_demo_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.episode', 1 => 'admin.news', 2 => 'sonata.user.admin.user', 3 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('Stream' => array('label' => 'Stream', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'admin.episode', 1 => 'admin.news')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'))));
        $instance->setAdminClasses(array('rj\\StreamBundle\\Entity\\Episode' => array(0 => 'admin.episode'), 'rj\\StreamBundle\\Entity\\News' => array(0 => 'admin.news'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.episode', 1 => 'admin.news', 2 => 'sonata.user.admin.user', 3 => 'sonata.user.admin.group'), $this);
    }
    ...
    {
        return $this->services['sonata.user.form.gender_list'] = new \Sonata\CoreBundle\Form\Type\StatusType('Sonata\\UserBundle\\Entity\\BaseUser', 'getGenderList', 'sonata_user_gender');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/rj/StreamBundle/Resources/views'), 'rjStream');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ZjqajiQkgtPcNwSAEKfui3DHh91CZfGm4fNHtVdQ');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'rjStreamBundle' => 'rj\\StreamBundle\\rjStreamBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'brostreaqjstream',
            'database_user' => 'admin',
            ...
            'locale' => 'fr_FR',
            'secret' => 'ZjqajiQkgtPcNwSAEKfui3DHh91CZfGm4fNHtVdQ',
            ...
            'kernel.secret' => 'ZjqajiQkgtPcNwSAEKfui3DHh91CZfGm4fNHtVdQ',
