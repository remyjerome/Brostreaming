...
Arya commence sa vie parmi les Sans-Visage, qui se montrent durs et la forcent à renoncer à tous ses biens personnels, y compris son épée. De leur côté, Tyrion et Varys se risquent à une sortie dans les rues de Volantis, le nain ne supportant plus l'enfermement. Mais en se rendant dans un bordel, ils croisent la route de Jorah Mormont, qui reconnait le Lannister et choisit de l'enlever pour le livrer à la « Reine ».");
    ...
    //S5 E5
    /*$episode = new episode(5,5);
    $episode->setTitre("Kill The Boy");
    $episode->setDescription("...");
    $episode->setLien('http://www.purevid.com/?m=embed&id=542040vrvysy994185ONJ52y6373');

    $em = $this->getDoctrine()->getManager();
    $em->persist($episode);
    $em->flush();*/
    //S5 E6
    $episode = new episode(5,6);
    $episode->setTitre("Unbowed, Unbent, Unbroken");
    $episode->setDescription("...");
    $episode->setLien('http://www.purevid.com/?m=embed&id=6619Dtqhpw424x0rp5783');
    ...
    //S5 E7
    $episode = new episode(5,7);
    $episode->setTitre("The Gift");
    $episode->setDescription("...");
    $episode->setLien('http://www.purevid.com/?m=embed&id=262xyypmnwpponsD9A188UTV9803');
    ...
    //S5 E8
    $episode = new episode(5,8);
    $episode->setTitre("Hardhome");
    $episode->setDescription("...");
    $episode->setLien('http://www.purevid.com/?m=embed&id=6619H42qq71fhiidf5203');
    ...
    //S5 E9
    $episode = new episode(5,9);
    $episode->setTitre("The Dance of Dragons");
    $episode->setDescription("...");
    $episode->setLien('http://www.purevid.com/?m=embed&id=282333kjk5E76B7y3y051zy05633');
